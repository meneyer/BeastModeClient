...
import { Container, Form, FormGroup, FormText, Label, Input, Button, Popover, PopoverHeader, PopoverBody } from 'reactstrap';
...
const EventUpdate = (props) => {
    ...
    const [editStartTime, setEditStartTime] = useState(props.updateEvent.startTime);
    ...
    const [editTravelPlan, setEditTravelPlan] = useState(props.updateEvent.travelPlan);
